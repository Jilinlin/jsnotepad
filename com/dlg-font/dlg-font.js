...
var $dlgFont = (function() {
  ...
  function init() {//初始化样式列表
    var lstFamily = new comList();//字体
    lstFamily.show({
  ...
  function destory() { $dlg.remove(); }//取消样式
